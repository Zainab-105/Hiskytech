...
<section class="footer desktop">
    ...
    <section class="footer mobile-version" style="display: none; padding: 26px;">
        <div class=" " >
            <div class="row"> <!-- Added w-100 for full row width -->
                <!-- First col-md-6 -->
                <div class="col-md-5 d-flex justify-content-center align-items-start">
                    <div class="card custom-card">
                        <!-- Card Image -->
    ...
    <div class="footer-copyright">
        <span>&copy;</span>
        <span>All Rights Reserved By HiSkyTech</span>
    </div>
        </div>
