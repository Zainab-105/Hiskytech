            ...
            <tbody>
                ...
                ?>
                            <tr>
                                ...
                                <!-- Action Column -->
                                <td>
                                    <a href="delete-services.php?id=<?= $service_id ?>" class="delete-btn"><i class="fas fa-trash-alt gray-icon"></i></a>
                                    <a href="edit_services.php?id=<?= $service_id ?>" class="edit-btn"><i class="fas fa-edit gray-icon"></i></a>
                                </td>
                            </tr>
                <?php
                            $a++;
